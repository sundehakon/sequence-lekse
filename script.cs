// Oppgave1 og 2 Her ligger dictionary med en liste over studenter og deres informasjon
...
// Disse er student IDene eller keys (nøkkel) som brukes til å søke mellom studentene senere i koden, slik at maskinenen kan finne dem i dictionary
...
// Oppgave3 Et set med forskjellige fagkoder som jeg bruker lenger ned hvor man skal skrive inn karakter til de forskjellige fagene
...
// Oppgave4 Lagde en liste for karakterene brukeren skriver inn lenger ned, som er derfor den er tom
...
// Ekstra feature som spør brukeren om de ønsker å skrive inn karakterer eller ikke, dersom de sier ja fortsetter koden som vanlig ved å skrive inn karakterer, skriver de nei blir de automatisk sendt til informasjonen om studenten de øsnket å se på, karakterer står da som "ikke oppgitt"
...
if (StudentRegister.ContainsKey(brukerInput)) // Sjekker om studentregister har keyen som brukerene skrev inn
{
    ...
    while (true)
        ...
        foreach (string fagkode in fagkoder) // Oppgave5 Foreach løkke som går gjennom alle fagkodene og ber brukeren skrive inn karakter til disse, verdien fra karakterene som skrives inn blir lagret i listen jeg lagde litt lenger oppe
            {
...
// Oppgave6 Skriver ut all informasjonen om studenten som ble valgt, inkludert karakterene som akkurat ble gitt
        Console.WriteLine("\nStudent ID: ");
